...
export default class CustomCircularProgressbar extends Component {
    ...
    render() {
        ...
        let pathColor = needRecommendations != true ? '#39B54A' : '#FF9540';
        let pathShadowColor = needRecommendations != true ? 'rgba(57, 181, 74, 0.5)' : 'rgba(255, 149, 64, 0.4)';
        let trailColor = '#AEC3ED';
        let width = '5px';
