                    ...
                    <Route render={({location}) => {
                        ...
                        <React.Fragment>
                            ...
                            {location.pathname !== '/question_recommendation' && location.pathname !== '/server_error' && (
                                <div className="card left-screen-card"></div>
                            )}
                            <div className="left-card-upper-div"></div>
                            
                            <TransitionGroup>
                            {/* <TransitionGroup 
                                childFactory={child => React.cloneElement(child, {
                                        classNames: this.getAnimation(location),
                                        timeout: 1000
                                    }
                            )}> */}
                                <CSSTransition key={location.key} 
                                    ...
                                    <Switch location={location}>
                                        <Route exact path="/" render={props => <QuestionPersonalView {...props} />}/>
                            ...
                            {location.pathname !== '/question_recommendation' && location.pathname !== '/server_error' && (
                                <div className="card right-screen-card"></div>
                            )}
                            <div className="right-card-upper-div"></div>                            
                        </React.Fragment>
                        );
                    }} />
                </Container>
